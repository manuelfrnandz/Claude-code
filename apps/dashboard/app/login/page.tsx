        ...
        <div className="mb-8">
          <div className="w-14 h-14 bg-brand-green rounded-xl flex items-center justify-center mx-auto mb-4">
            <svg viewBox="0 0 24 24" fill="white" className="w-8 h-8">
              ...
              <path d="M12 0C5.373 0 0 5.373 0 12c0 2.136.561 4.14 1.541 5.879L.057 23.636a.75.75 0 0 0 .918.918l5.757-1.484A11.955 11.955 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.75 9.75 0 0 1-4.974-1.364l-.357-.214-3.705.954.975-3.607-.233-.37A9.75 9.75 0 1 1 12 21.75z" />
            </svg>
          </div>
